...
puts "Creating users..."
daniel = User.create(first_name: "Daniel", last_name: "Mekuriaw", date_of_birth: Faker::Date.between(from: '2001-07-16', to: '2001-07-16'), nationality: "Ethiopian", education_status: "Undergraduate Student", country_of_residence: "United States of America")
